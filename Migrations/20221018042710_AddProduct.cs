        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeFlag = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    SupplierId = table.Column<int>(type: "int", nullable: false),
                    BookLayout = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PageCount = table.Column<int>(type: "int", nullable: true),
                    PublicationDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 4, nullable: true),
                    Translator = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductImageProducts", x => new { x.ProductId, x.ImageProductId });
                    table.ForeignKey(
                        name: "FK_ProductImageProducts_ImageProducts_ImageProductId",
                        column: x => x.ImageProductId,
                        principalTable: "ImageProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductImageProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImageProducts_ImageProductId",
                table: "ProductImageProducts",
                column: "ImageProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_AgeId",
                table: "Products",
                column: "AgeId");
